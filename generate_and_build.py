...
def run(config, prompts=None):
    ...
    # Gemini がプロンプト例の "ElevenLabs 使い方" をオウム返しして同一記事量産が発生。
    ...
    try:
        ...
        from seo_optimizer import ElevenLabsSEOOptimizer
        ...
        optimizer = ElevenLabsSEOOptimizer(config)
    ...
    try:
        from site_generator import ElevenLabsSiteGenerator
        site_gen = ElevenLabsSiteGenerator(config)
        site_gen.build_site()
